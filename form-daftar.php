			...
			<div class="wrap-login100 p-t-190 p-b-30">
				<form class="login100-form validate-form">
                    ...
                    <label for="css">Laki-Laki</label><br> -->
						<input class="input100" type="text" name="alamat" placeholder="Jenis Kelamin (L/P)">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-user"></i>
						</span>
                    ...
                    <div class="wrap-input100 validate-input m-b-10" data-validate = "Asal Sekolah is required">
						<input class="input100" type="text" name="asal_sekolah" placeholder="Asal Sekolah">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-home"></i>
						</span>
